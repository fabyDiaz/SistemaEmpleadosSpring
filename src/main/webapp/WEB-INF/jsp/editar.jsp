...
<div class = "container">
    ...
    <form action="${urlEditar}" modelAttribute="empleadoForma" method="post">
        ...
        <div class="mb-3">
            ...
            id="nombreEmpleado" required="true" value="${empleado.nombreEmpleado}">

        </div>
        <div class="mb-3">
            <label for="departamento" class="form-label" >Departamento:</label>
            <input type="text" class="form-control" name = "departamento"
            id="departamento" required="true" value="${empleado.departamento}">
        </div>
        <div class="mb-3">
            <label for="sueldo" class="form-label">Sueldo:</label>
            <input type="number" step="any" class="form-control" name="sueldo"
            id="sueldo" required="true" value="${empleado.sueldo}">
        </div>
